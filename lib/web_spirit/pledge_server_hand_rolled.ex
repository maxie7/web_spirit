defmodule WebSpirit.GenericServer do
...
defmodule WebSpirit.PledgeServerHandRolled do

  @name :pledge_server_hand_rolled
  alias WebSpirit.GenericServer
...
#alias WebSpirit.PledgeServerHandRolled
#
#pid = PledgeServerHandRolled.start();
#
#send pid, {:stop, "hammertime"}
#
#IO.inspect PledgeServerHandRolled.create_pledge("pepe", 10)
